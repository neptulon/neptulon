...
// 		c.SendRequest("echo", echoMsg{Message: m}, handleEchoRes(t, m, &wg))
// 		return nil
// 	})
//
...
//
// 		wg.Add(1)
// 		ch.SendRequest("echo", echoMsg{Message: m}, handleEchoRes(t, m, nil))
// 		cm := "Thanks for echoing! Over and out."
// 		ch.SendRequest("close", echoMsg{Message: cm}, handleEchoRes(t, cm, nil))
// 	}
//
// 	// wg.Wait()
// }
